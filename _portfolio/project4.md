...
subtitle: Automated evidence collection for SOC 2 and ISO workflows.
title_ko: 컴플라이언스 모니터
subtitle_ko: SOC 2와 ISO 워크플로에 필요한 증적을 자동으로 수집합니다.
image: assets/img/portfolio/04-full.jpg
alt: Automated compliance dashboard with charts
